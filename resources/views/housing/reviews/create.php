...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-center text-indigo-700 mb-8">Write a Review for "<?= $housingPost->title ?>"</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            ...
            <form action="/housing/<?= $housingPost->id ?>/reviews" method="POST" class="space-y-6">
                <?= csrf_field() ?>
                    ...
                    <div class="grid md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <label class="rating-label">
                                    <input type="radio" name="cleanliness_rating" value="<?= $i ?>" required class="hidden peer">
                                    <span class="rating-star text-2xl cursor-pointer text-gray-300 peer-checked:text-yellow-400">★</span>
                                </label>
                                <?php endfor; ?>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                <label class="rating-label">
                                    <input type="radio" name="location_rating" value="<?= $i ?>" required class="hidden peer">
                                    <span class="rating-star text-2xl cursor-pointer text-gray-300 peer-checked:text-yellow-400">★</span>
                                </label>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                <label class="rating-label">
                                    <input type="radio" name="value_rating" value="<?= $i ?>" required class="hidden peer">
                                    <span class="rating-star text-2xl cursor-pointer text-gray-300 peer-checked:text-yellow-400">★</span>
                                </label>
                                <?php endfor; ?>
                            </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                <label class="rating-label">
                                    <input type="radio" name="landlord_rating" value="<?= $i ?>" required class="hidden peer">
                                    <span class="rating-star text-2xl cursor-pointer text-gray-300 peer-checked:text-yellow-400">★</span>
                                </label>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <?php for ($i = 1; $i <= 5; $i++): ?>
                                <label class="rating-label">
                                    <input type="radio" name="safety_rating" value="<?= $i ?>" required class="hidden peer">
                                    <span class="rating-star text-2xl cursor-pointer text-gray-300 peer-checked:text-yellow-400">★</span>
                                </label>
                                <?php endfor; ?>
                            </div>
                ...
                <div>
                    ...
                    <textarea name="review_text" id="review_text" rows="5" 
                              ...
                              placeholder="Share details about your experience at this property..."></textarea>
                </div>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="anonymous" id="anonymous" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
